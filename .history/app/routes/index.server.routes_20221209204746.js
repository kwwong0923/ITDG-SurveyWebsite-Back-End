...
router.post("/api/post-survey",authController.authCheck(), indexController.apiPostSurvey );

router.delete("/api/delete-survey/:surveyId",authController.authCheck(), indexController.apiDeleteSurvey);
